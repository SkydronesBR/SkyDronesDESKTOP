...
FirstRunPrompt {
    ...
    ColumnLayout {
        ...
        QGCLabel {
            ...
            text:       qsTr("Escolha as unidades de medida que deseja usar. Você também pode alterá-lo posteriormente nas Configurações Gerais.")
